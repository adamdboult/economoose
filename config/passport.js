    ...
    new LocalStrategy(
      ...
      function (req, username, password, done) {
        ...
        User.findOne(
          {
            $or: [
              { "local.email": req.param("email").toLowerCase() },
          ...
          function (err, user) {
            ...
            if (user) {
              ...
              return done(
                null,
                false,
                req.flash("signupMessage", "Please use a valid password."),
              );
            } else if (validateUsername(username.toLowerCase()) === false) {
              return done(
                null,
                false,
                req.flash("signupMessage", "Please use a valid username."),
              );
            } else if (
              validateEmail(req.param("email").toLowerCase()) === false
            ) {
              return done(
                null,
                false,
                req.flash("signupMessage", "Please use a valid email address."),
              );
            } else {
